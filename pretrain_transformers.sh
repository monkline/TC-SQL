...
max_train_steps=(15000 0 15000 15000 0 5000 0 0)
resume_from_checkpoint=(pretrained-models/AG/step_9000 1 \
pretrained-models/SS/step_10000 pretrained-models/Bio/step_10000 \
1 1 \
1 1)
...
CUDA_VISIBLE_DEVICES=0 python pretrain_transformers.py \
    ...
    --max_seq_length 32\
    --resume_from_checkpoint ${resume_from_checkpoint[$i]}
